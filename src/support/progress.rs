...
//! Used by: `run::grep`.
//! Uses: `mf_scan::engine` (the search + the [`Progress`] trait it implements)
//! and `mf_scan::source` (the [`Source`] it searches).
//!
...
use mf_scan::engine::{Findings, Progress, Query, search_source};
