...
//! `crate::cmd::support` machinery (source resolution, the output sink, the export report).
//!
...
use mf_scan::core::models::{Entry, RunInfo};
use mf_scan::core::source::Source;
use mf_scan::ops::diff::{Change, CompareMode, DiffReport, diff_sources};
use mf_scan::ops::search::MatchedFile;
use mf_scan::report::diff::write_diff;

use crate::cmd::cli::DiffArgs;
