...
//! drift.
//! Uses: `crate::sqlite` (the `Manifest.db` reader), `super::manifest`
//! (`MBFile` decode), `crate::source` (the `Source` trait), `sha1`.
...
use crate::ios::backup::manifest::{MBFile, parse_mbfile};
use crate::models::{Entry, Location};
use crate::source::{IntegrityCheck, Source};
use crate::sqlite::{Value as SqliteValue, read_table as read_sqlite_table};
